...
{
    public sealed class FileDspDriver_old : IDspDriver
    {
        ...
        public FileDspDriver_old(string filename, int intervalLength)
        {
        ...
        {
            private readonly FileDspDriver_old driver;

            public Context(FileDspDriver_old driver)
            {
                this.driver = driver;
            }
